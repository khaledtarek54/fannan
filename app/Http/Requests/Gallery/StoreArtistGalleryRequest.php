...
class StoreArtistGalleryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        // [SECURITY] When an actual file is uploaded (vs a pre-stored path), restrict its mimetype
        // and size so arbitrary executables / oversized files can't be stored (L3).
