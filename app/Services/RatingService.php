...
class RatingService
{
    ...
    public function store(array $payload): bool
    {
        ...
        // [SECURITY] One rating per model per client. Without this a client could call this
        // repeatedly (rating is now review-only, but spamming/IDOR is still wrong). See B2.
        ...
        // [BL1/B2] Rating is a review ONLY. The artist is paid on order completion
